...
const getMachineGuestImageController = async (req: RequestBody, res: Response) => {
    logger.verbose('[Machines, getMachineGuestImage]');
    ...
    try {
        ...
        logger.error('[Machines, getMachineGuestImage]', error)
        res.status(501).json(null);
    }
}

export default getMachineGuestImageController
