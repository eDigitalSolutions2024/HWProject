...
const getMachineGuestTagController = async (req: RequestBody, res: Response) => {
    logger.verbose('[Machines, getMachineGuestTag]');
    ...
    try {
        ...
        logger.error('[Machines, getMachineGuestTag]', error)
        res.status(501).json(null);
    }
}

export default getMachineGuestTagController
