...
import { updateMachineImageAction } from '@machineActions';
//form
import { useForm } from "react-hook-form";

const UpdateMachineImageForm = ({ setShow }) => {
    ...
    const uploadDocument = async formData => {
        const { file } = formData;
        await dispatch(updateMachineImageAction(currentMachine._id, file[0]))
        setShow(false)
    }
...
export default UpdateMachineImageForm